...
public class atomic_arrangement {
  ...
  public static void main(String[] args) {
    ...
    a_types=1;
    a=3.639+4.53242*1e-5*tempurature;
    lat=20;
    ...
    try {
      ...
      /* セルの条件設定 */        
      //pw.format("# atomic arrangement of %s metal : %s\n",structure,metal);//一行目のコメント記述
      pw.format("#%s\n",metal);
      pw.println("");
      pw.format("%d atoms\n",(int)N);
